...
- (void)createButtonWithText:(NSString *)text withFrame:(CGRect)frame
{
	...
	else
	{
		...
		button = [UnderlineButton buttonWithType:UIButtonTypeCustom]; // autoreleased
	}
	...
	[button setTitle:[text stringByTrimmingCharactersInSet:[NSCharacterSet characterSetWithCharactersInString:@"\""]] forState:UIControlStateNormal];
...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame]))
	{
		...
		self.highlightColor = [UIColor cyanColor];
