...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
	...
	return NSLocalizedString(@"Enter your state:", @"");
}
...
*/
	...
	cellTextField.textField.text = profile.state;
...
- (void) done:(id)sender 
{
	profile.state = [NSString stringWithString:cellTextField.textField.text];
