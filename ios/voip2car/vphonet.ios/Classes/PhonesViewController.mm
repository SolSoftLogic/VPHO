...
- (void)viewDidLoad
{
	...
	[self setTitle:NSLocalizedString(@"Phones", @"")];
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
	...
	return NSLocalizedString(@"Enter your phone number:", @"");
}
...
*/    
	...
	cellTextField.textField.text = profile.phoneHome;
...
- (void) done:(id)sender 
{
	profile.phoneHome = [NSString stringWithString:cellTextField.textField.text];
