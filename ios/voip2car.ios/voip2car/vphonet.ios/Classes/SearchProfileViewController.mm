...
//@property (nonatomic, retain) EditingTableViewCell *cellFirstName;
...
//				[UIImage imageNamed:@"profile_picture.png"];
		...
		case 1:
		{
			...
			{
				cellFirstName = cell;
				cellFirstName.label.text = NSLocalizedString(@"First Name:", @"");
				[cellFirstName.textField setText:contact.firstName];
				[cellFirstName retain];
				return cellFirstName;
			} else if (indexPath.row == 1)
			{
				cellLastName = cell;
				cellLastName.label.text = NSLocalizedString(@"Last Name:", @"");
				[cellLastName.textField setText:contact.lastName];
				[cellLastName retain];
				return cellLastName;
		...
		case 2:
			if (indexPath.row == 0)
			{
				...
				[cellButtonAdd.button setTitle:NSLocalizedString(@"Add", @"") forState:UIControlStateNormal];
