...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (cell != nil) {
		...
		switch (indexPath.row) {
			case 0:
				[[VPProfile singleton] setStatus:AOL_ONLINE];
				[[VPEngine sharedInstance] setUserStatus:AOL_ONLINE];
				break;
			case 1:
				[[VPProfile singleton] setStatus:AOL_OFFLINE];
				[[VPEngine sharedInstance] setUserStatus:AOL_OFFLINE];
				
				break;
			case 2:
				[[VPProfile singleton] setStatus:AOL_LIMITED];
				[[VPEngine sharedInstance] setUserStatus:AOL_LIMITED];
				break;
			default:
//				[[VPProfile singleton] setStatus:USERSTATUS_LIMITED];
//				[[VPEngine sharedInstance] setUserStatus:USERSTATUS_LIMITED];
				break;
		}
